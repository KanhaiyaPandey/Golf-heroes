...
export const metadata: Metadata = {
  title: {
    default: "Golf Heroes — Play. Give. Win.",
    template: "%s | Golf Heroes",
  },
  description:
    "Track your golf scores, support your favourite charity, and win monthly prizes. Golf Heroes combines performance tracking with meaningful impact.",
  keywords: ["golf", "charity", "prizes", "stableford", "golf scores", "prize draw"],
  openGraph: {
